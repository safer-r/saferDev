testthat::test_that(".in_parenthesis_replacement()", {
    ...
    # testthat::expect_no_error(.in_parenthesis_replacement(string = str1, pattern = pattern1, no_regex_pattern = pattern1, replacement = " ", perl = TRUE, open_pos = open_pos1, close_pos = close_pos1, lib_path = NULL, error_text = "")) # cannot be tested because safer_check is not present and lib_path is checked only is safer_check = TRUE in the enclosing function
    testthat::expect_no_error(.in_parenthesis_replacement(string = str1, pattern = pattern1, no_regex_pattern = pattern1, replacement = " ", perl = TRUE, open_pos = open_pos1, close_pos = close_pos1, lib_path = NULL, error_text = "")) 
