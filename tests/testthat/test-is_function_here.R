testthat::test_that("is_function_here()", {
    ...
    testthat::expect_error(is_function_here(error_text = "")) # safer error message of arg with no default values (even if the same objects exist in the R scope)
    rm(
        fun,
        safer_check,
        lib_path,
    ...
    testthat::expect_error(is_function_here(fun = str1, safer_check = str1, lib_path = NULL, error_text = ""))
    # end pattern
