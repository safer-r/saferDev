...
```{r}
arg_check(data = vec3, typeof = "integer",
...
### Argument na.contain
```{r}
arg_check(data = mat2, class = "matrix", prop = TRUE,
...
arg_check(data = mat1, class = "matrix",
...
res <- arg_check(data = mat1, class = "data.frame",
    print = FALSE
)
...
res <- arg_check(data = mat1, class = "matrix",
    print = TRUE
)
```
<br>
...
```{r}
# Example
tempo <- arg_check(data = vec1, class = "integer", 
...
fun1 <- function(arg1){
    tempo <- arg_check(data = arg1, class = "integer", 
...
```{r}
arg_check(data = mat1, class = "matrix", safer_check = TRUE) # safer_check = TRUE, checkings are performed before main code running

arg_check(data = vec4, options = c("pearson", "spearman", "kendall"), safer_check = TRUE) # safer_check = TRUE, checkings are performed before main code running
```
<br>
